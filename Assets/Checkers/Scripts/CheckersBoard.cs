...
namespace Checkers
{
    public class CheckersBoard : MonoBehaviour
    {
        ...
        {
            var forcedPieces = GetPossibleMoves();
        ...
        public bool IsForcedMove(Piece piece)
        {
            ...
            if (piece.isWhite || piece.isKing)
            {
                for (int i = -1; i <= 1; i++)
                {
                    for (int j = -1; j < 1; j++)
                    {
                        ...
                        // Try getting the piece at the coordinates.
            ...
            // There is no forced move for this piece
            return false;
